...
def make_sequential_model(config):
...
def make_sequential_hparams(config):
    resize_rescale = Sequential([Resizing(config['image_size'].domain_values[0], config['image_size'].domain_values[1]), Rescaling(1/255)])
